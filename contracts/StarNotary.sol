...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You do now own either of the stars");
        address owner1 = ownerOf(_tokenId1);
        _transferFrom(ownerOf(_tokenId1), ownerOf(_tokenId2), _tokenId1);
        _transferFrom(ownerOf(_tokenId2), owner1, _tokenId2);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You do not own this star");
